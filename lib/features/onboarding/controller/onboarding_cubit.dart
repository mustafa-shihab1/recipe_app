...
import 'package:recipe_app/core/storage/local/app_settings_shared_preferences.dart';
...
class OnboardingCubit extends Cubit<OnboardingState> {
  ...
  final AppSettingsSharedPreferences _appSettings = instance<AppSettingsSharedPreferences>();
